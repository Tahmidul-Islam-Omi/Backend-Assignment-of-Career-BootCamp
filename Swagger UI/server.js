...
// No need to import fetch as it's built into newer Node.js versions

const app = express();
const PORT = 3003;
const SWAGGER_JSON_URL = "http://localhost:3002/api-docs.json"; // Replace with actual backend URL
